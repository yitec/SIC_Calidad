    ...
    <div class="maestro_titulo">Archivo</div></br></br></br>
     <?php				
									while($info=mysql_fetch_array($dt)){
										echo '
    <div class="maestro_lista">'.utf8_encode($info[9]).'</div><div class="maestro_lista">'.utf8_encode($info[10]).'</div><div class="maestro_lista">'.utf8_encode($info[3]).'</div><div class="maestro_lista">'.utf8_encode($info[4]).'</div><div class="maestro_lista"><a href="archivos/ControlCalidad/'.utf8_encode($info[7]).'">Ver Archivo</a></div>
   </br></br>';}?>
    </div>
